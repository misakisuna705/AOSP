...
```zsh
python profiler.py [-h] [-b BENCHMARK] [-o OUTPUTFILE]

# Mibench
python profiler.py -b "/data/local/tmp/Mibench/bitcnts 84600000" -o "output/Mibench/bitcnts/84600000.csv"

# LMbench
python profiler.py -b "/data/local/tmp/LMbench/bw_mem 512m rd" -o "output/LMbench/bw_mem/512m/rd.csv"
python profiler.py -b "/data/local/tmp/LMbench/bw_mem 512m frd" -o "output/LMbench/bw_mem/512m/frd.csv"
python profiler.py -b "/data/local/tmp/LMbench/bw_mem 512m cp" -o "output/LMbench/bw_mem/512m/cp.csv"
python profiler.py -b "/data/local/tmp/LMbench/bw_mem 512m fcp" -o "output/LMbench/bw_mem/512m/fcp.csv"
python profiler.py -b "/data/local/tmp/LMbench/bw_mem 512m bzero" -o "output/LMbench/bw_mem/512m/bzero.csv"
python profiler.py -b "/data/local/tmp/LMbench/bw_mem 512m bcopy" -o "output/LMbench/bw_mem/512m/bcopy.csv"

# Dhrystone
python profiler.py -b "/data/local/tmp/Dhrystone/dry" -o "output/Dhrystone/dry.csv"
