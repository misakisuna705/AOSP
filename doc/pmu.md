...
| type              | num  | event                      | description                      | note                   | spec | hw  |     |
| ----------------- | ---- | -------------------------- | -------------------------------- | ---------------------- | ---- | --- | --- |
...
|                   | 0x6E | raw-strex-fail-spec        |                                  | ⊆ -strex-spec          |      |     |     |
|                   | 0x90 | raw-rc-ld-spec             |                                  | ⊆ -inst-spec           |      |     |     |
|                   | 0x91 | raw-rc-st-spec             |                                  | ⊆ -inst-spec           |      |     |     |
|                   | 0x7C | raw-isb-spec               |                                  | ⊆ -inst-spec           |      |     |     |
|                   | 0x7D | raw-dsb-spec               |                                  | ⊆ -inst-spec           |      |     |     |
|                   | 0x7E | raw-dmb-spec               |                                  | ⊆ -inst-spec           |      |     |     |
...
|                   | 0x83 | raw-exc-pabort             |                                  | ⊆ -exc-taken           |      |     |     |
|                   | 0x8B | raw-exc-trap-pabort        |                                  | ⊆ -exc-pabort          |      |     |     |
|                   | 0x84 | raw-exc-dabort             |                                  | ⊆ -exc-taken           |      |     |     |
|                   | 0x8C | raw-exc-trap-dabort        |                                  | ⊆ -exc-dabort          |      |     |     |
|                   | 0x86 | raw-exc-irq                |                                  | ⊆ -exc-taken           |      |     |     |
|                   | 0x8E | raw-exc-trap-irq           |                                  | ⊆ -exc-irq             |      |     |     |
|                   | 0x87 | raw-exc-fiq                |                                  | ⊆ -exc-taken           |      |     |     |
|                   | 0x8F | raw-exc-trap-fiq           |                                  | ⊆ -exc-fiq             |      |     |     |
|                   | 0x88 | raw-exc-smc                |                                  | ⊆ -exc-taken           |      |     |     |
|                   | 0x8A | raw-exc-hvc                |                                  | ⊆ -exc-taken           |      |     |     |
...
|                   | 0x47 | raw-l1d-cache-wb-clean     |                                  | ⊆ -l1d-cache-wb        |      |     |     |
|                   | 0x48 | raw-l1d-cache-inval        |                                  |                        |      |     |     |
| L1 D-Cache TLB    | 0x25 | raw-l1d-tlb                | = -rd + -wr                      |                        |      |     |     |
|                   | 0x4E | raw-l1d-tlb-rd             |                                  | ⊆ -l1d-tlb             |      |     |     |
|                   | 0x4F | raw-l1d-tlb-wr             |                                  | ⊆ -l1d-tlb             |      |     |     |
...
|                   | 0x57 | raw-l2d-cache-wb-clean     |                                  | ⊆ -l2d-cache-wb        |      |     |     |
|                   | 0x58 | raw-l2d-cache-inval        |                                  |                        |      |     |     |
| L2 D-Cache TLB    | 0x2F | raw-l2d-tlb                | = -rd + -wr                      |                        |      |     |     |
|                   | 0x5E | raw-l2d-tlb-rd             |                                  | ⊆ -l2d-tlb             |      |     |     |
|                   | 0x5F | raw-l2d-tlb-wr             |                                  | ⊆ -l2d-tlb             |      |     |     |
