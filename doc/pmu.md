...
| type              | num  | event                      | description                      | note                   | spec | hw  | zero |     |     |
| ----------------- | ---- | -------------------------- | -------------------------------- | ---------------------- | ---- | --- | ---- | --- | --- |
...
| instr. other      |      | raw-op-retired             |                                  | ⊆ -inst-retired        | x    |     | x    |     |     |
...
|                   | 0x6A | raw-unaligned-ldst-spec    | = -ld-spec + -st-spec            | ⊆ -inst-spec           |      |     | x    |     |     |
|                   | 0x68 | raw-unaligned-ld-spec      |                                  | ⊆ -unaligned-ldst-spec |      |     | x    |     |     |
|                   | 0x69 | raw-unaligned-st-spec      |                                  | ⊆ -unaligned-ldst-spec |      |     | x    |     |     |
| op. other         |      | raw-op-spec                | ≈ -retired                       | ⊆ -inst-spec           | x    |     | x    |     |     |
|                   |      | raw-sve-inst-spec          | ≈ -retired                       | ⊆ -inst-spec           | x    |     | x    |     |     |
...
| L2 I-Cache        |      | raw-l2i-cache              |                                  |                        | x    |     | x    |     |     |
|                   |      | raw-l2i-cache-refill       |                                  | ⊆ -l2i-cache           | x    |     | x    |     |     |
|                   |      | raw-l2i-cache-lmiss        |                                  | ⊆ -l2i-cache-refill    | x    |     | x    |     |     |
| L2 I-Cache TLB    |      | raw-l2i-tlb                |                                  |                        | x    |     | x    |     |     |
|                   |      | raw-l2i-tlb-refill         |                                  | ⊆ -l2i-tlb             | x    |     | x    |     |     |
