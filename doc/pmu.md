...
|              | 0x70 | raw-ld-spec                |                           | -retired             | ⊆ -ldst-spec           |      | 12  |      |       |      |        |
...
|              | 0x71 | raw-st-spec                |                           | -retired             | ⊆ -ldst-spec           |      | 13  |      |       |      |        |
...
| L2 I AC      |      | raw-l2i-cache              | L1 <=> "L2"               |                      |                        | x    |     | x    |       |      |        |
|              |      | raw-l2i-cache-refill       | L1 <=> "L2" ∋ "L2" <= L3  |                      | ⊆ -l2i-cache           | x    |     | x    |       |      |        |
|              |      | raw-l2i-cache-lmiss        |                           |                      | ⊆ -l2i-cache-refill    | x    |     | x    |       |      |        |
| L2 I TLB     |      | raw-l2i-tlb                | L1 <=> "L2"               |                      |                        | x    |     | x    |       |      |        |
|              |      | raw-l2i-tlb-refill         | L1 <=> "L2" ∋ "L2" <= L3  |                      | ⊆ -l2i-tlb             | x    |     | x    |       |      |        |
...
|              | 0x20 | raw-l2d-cache-allocate     | L1 => "L2"                | -l2d-cache-wr        | ⊆ -l2d-cache-wr        |      | 14  |      |       |      |        |
| L1 D WB      | 0x15 | raw-l1d-cache-wb           | "L1" => L2                | -l2d-cache-wr        | ⊆ -l2d-cache-allocate  |      | 14  |      |       |      |        |
...
|              |      | raw-ll-cache               |                           | -l3d-cache           |                        | x    | 15  | x    |       |      |        |
|              | 0x2A | raw-l3d-cache-refill       | L2 <=> "L3" ∋ "L3" <= MEM | -rd + -wr            | ⊆ -l3d-cache           |      | 16  |      |       |      |        |
|              |      | raw-ll-cache-miss          |                           | -l3d-cache-refill    | ⊆ -ll-cache            | x    | 16  | x    |       |      |        |
| L3 D RD      |      | raw-l3d-cache-rd           | L2 <= "L3"                |                      | ⊆ -l3d-cache           | x    | 17  |      |       |      |        |
|              | 0x36 | raw-ll-cache-rd            |                           | -l3d-cache-rd        | ⊆ -ll-cache            |      | 17  |      |       |      |        |
|              |      | raw-l3d-cache-refill-rd    | L2 <= "L3" ∋ "L3" <= MEM  |                      | ⊆ -l3d-cache-rd        | x    | 18  |      |       |      |        |
|              | 0x37 | raw-ll-cache-miss-rd       |                           | -l3d-cache-refill-rd | ⊆ -ll-cache-rd         |      | 18  |      |       |      |        |
...
|              | 0x29 | raw-l3d-cache-allocate     | L2 => "L3"                | -l3d-cache-wr        | ⊆ -l3d-cache-wr        |      | 19  |      |       |      |        |
| L2 D WB      | 0x18 | raw-l2d-cache-wb           | "L2" => L3                | -l3d-cache-wr        | ⊆ -l3d-cache-allocate  |      | 19  |      |       |      |        |
...
|              |      | raw-l3d-cache-wb           | "L3" => MEM               | -mem-access-wr       | ⊆ -mem-access-wr       | x    | 20  | x    |       |      |        |
...
| sample       |      | raw-sample-feed            |                           |                      |                        | x    |     | x    |       |      |        |
|              |      | raw-sample-filtrate        |                           |                      |                        | x    |     | x    |       |      |        |
|              |      | raw-sample-pop             |                           |                      |                        | x    |     | x    |       |      |        |
|              |      | raw-sample-collision       |                           |                      |                        | x    |     | x    |       |      |        |
| OTS          | 0x1E | raw-chain                  |                           |                      |                        | -    | -   | -    | -     | -    | -      |
